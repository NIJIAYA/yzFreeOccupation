    ...
    <div class="topArea">
        <div class="textArea_top">
          <div style="width: 100%;height: 5vh">
            <img style="width:8.4vw;height:3.7vh;position: absolute;left: 1.4vw;margin-top: 4.6vh;cursor: pointer;" src="../../assets/images/yzFreeOccupationImages/top_title_button.png" @click="showimg('1')">
            <img style="width:8.4vw;height:3.7vh;position: absolute;right: 11.6vw;margin-top: 4.6vh;cursor: pointer;" src="../../assets/images/yzFreeOccupationImages/top_title_buttonright1.png" @click="showimg('2')">
            <img style="width:8.4vw;height:3.7vh;position: absolute;right: 1.4vw;margin-top: 4.6vh;cursor: pointer;" src="../../assets/images/yzFreeOccupationImages/top_title_buttonright2.png" @click="showimg('3')">
          </div>
